<?php
/* Smarty version 4.3.4, created on 2024-08-19 17:39:59
  from '/home/townysag/public_html/custom/templates/Cobalt/members/members.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66c3e5dfad3831_37187399',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7fd4418a7d41407de34de637df3be4e50b389dab' => 
    array (
      0 => '/home/townysag/public_html/custom/templates/Cobalt/members/members.tpl',
      1 => 1724111908,
      2 => 'file',
    ),
  ),
...
function content_66c3e5dfad3831_37187399 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="user-nav-link<?php if ($_smarty_tpl->tpl_vars['VIEWING_LIST']->value == $_smarty_tpl->tpl_vars['list']->value->getName()) {?> active<?php }?>"><i
                            class="<?php if ($_smarty_tpl->tpl_vars['list']->value->getIcon()) {
echo $_smarty_tpl->tpl_vars['list']->value->getIcon();
} else { ?>dot circle icon<?php }?>"></i>
                        <?php echo $_smarty_tpl->tpl_vars['list']->value->getFriendlyName();?>
</a>
                <?php
}
...
$_smarty_tpl->tpl_vars['list']->do_else = false;
?>
                    <div class="<?php if ($_smarty_tpl->tpl_vars['VIEWING_LIST']->value == "overview") {?>col-lg-4<?php } else { ?>col-lg-12<?php }?> members-col">
                        <div class="card members-card">
                            <div class="card-header header-theme"><?php echo $_smarty_tpl->tpl_vars['list']->value->getFriendlyName();?>
</div>
                            <div class="card-body">
                                <div style="margin-bottom: 2rem" id="member_list_<?php echo $_smarty_tpl->tpl_vars['list']->value->getName();?>
">
                                </div>
            ...
            .then(async response => {
                ...
                for (const member of data) {
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['VIEWING_LIST']->value != "overview") {?>
                        ...
                        metaSpan.innerHTML = Object.keys(memberMeta).map(key => key + ': ' + memberMeta[key])
                            .join(' &middot; ');
