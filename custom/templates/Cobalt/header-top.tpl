...
<html{$HTMLCLASS}{$HTMLLANG}{$HTMLRTL} class="dark" id="html">
	<head>
		...
		{else}
			...
			{if isset($THEME_HOME_SEO_IMAGE) && $THEME_HOME_SEO_IMAGE|count_characters > 0}
				<meta property="og:image" content="{$THEME_HOME_SEO_IMAGE}" />
			{/if}
		{/if}
		...
		{else}
			...
			{if isset($THEME_HOME_SEO_IMAGE) && $THEME_HOME_SEO_IMAGE|count_characters > 0}
				<meta property="twitter:card" content="summary_large_image"/>
				<meta property="twitter:image" content="{$THEME_HOME_SEO_IMAGE}" />
			{/if}
		{/if}
