...
<div class="container">
    ...
    <div class="row">
        ...
        {if count($PAGES)}
            ...
            <div class="col-lg-4 col-xl-3 identifiera">
                ...
                <div {if $STICKY_SIDEBAR}id="stickybar" style="z-index:10;"{/if}>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="padding-top: 0px; z-index: 20;">
            ...
            <div class="{if count($WIDGETS_RIGHT) }col-lg-5 col-xl-6{else}col-lg-8 col-xl-9{/if}">
