        ...
        <div class="col-lg-9">
            <div class="card">
                <div class="card-header header-theme">
                    {$SUGGESTIONS}
                    {if isset($CAN_CREATE)}
                        <a class="btn btn-theme float-right" href="{$NEW_SUGGESTION_LINK}"><span class="mobile_only"><i class="fa-solid fa-plus"></i></span><span class="web_only">{$NEW_SUGGESTION}</span></a>
                    {/if}
